...
CREATE TABLE `sku` (
  ...
  -- category_id本来应该是和spu相关的，这样做是违反了第二范式的
  -- 但是这么做可以提高性能，避免中间商赚差价，某些查找频率很高的部分，减少一次join会提高很多性能
...
CREATE TABLE `theme` (
  ...
  `create_time` datetime(3) DEFAULT CURRENT_TIMESTAMP(3),
  `tpl_name` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,-- 主题的模板的name，用于前端渲染
  `update_time` datetime(3) DEFAULT CURRENT_TIMESTAMP(3) ON UPDATE CURRENT_TIMESTAMP(3),
  `delete_time` datetime(3) DEFAULT NULL,
  `entrance_img` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,-- 主题入口图片
  `extend` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL, -- 防御性地保证方便扩展字段，平时是没用的
  `internal_top_img` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,-- 主题详情页面顶部的图片
  `title_img` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL, -- 入口上面的图片，比如热卖榜单栏目上面那个“热卖榜单”这张图片
  `online` tinyint(3) unsigned DEFAULT '1', -- 是否上线了
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
